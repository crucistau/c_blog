...
import xyz.crucistau.domain.request.oauth.GiteeBody;
import xyz.crucistau.domain.request.oauth.GithubBody;
import xyz.crucistau.enums.RegisterOrLoginTypeEnum;
