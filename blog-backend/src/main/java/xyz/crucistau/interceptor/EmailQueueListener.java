package xyz.crucistau.interceptor;
...
import xyz.crucistau.constants.RabbitConst;
import xyz.crucistau.constants.RedisConst;
import xyz.crucistau.domain.email.CommentEmail;
import xyz.crucistau.domain.email.LeaveWordEmail;
import xyz.crucistau.domain.email.ReplyCommentEmail;
    ...
    public void handlerMapMessage(Map<String, Object> data) {
        ...
        if (MailboxAlertsEnum.REGISTER.getCodeStr().equals(type)) {
            mimeMessage = sendHtmlMail(email, MailboxAlertsEnum.REGISTER.getSubject(), MailboxAlertsEnum.REGISTER.getTemplateName(), Map.of(
                    ...
                    "code", code,
                    "toUrl", webIndexPath,
                    "openSourceAddress", "https://gitee.com/kuailemao/c-blog"
            ));
